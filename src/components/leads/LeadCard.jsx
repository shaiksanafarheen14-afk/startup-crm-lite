...
const LeadCard = ({ lead, onEdit, onDelete }) => {
  return (
    <div className="bg-card rounded-xl shadow-nordic border border-border overflow-hidden hover:shadow-md transition-all duration-200">
      <div className="p-6">
        ...
        <div className="space-y-2 mb-5">
          <div className="flex items-center text-sm text-text-secondary">
            <Mail size={14} className="mr-2 text-text-secondary/50 dark:text-text-secondary" />
            <span className="truncate">{lead.email}</span>
          </div>
          {lead.phone && (
            <div className="flex items-center text-sm text-text-secondary">
              <Phone size={14} className="mr-2 text-text-secondary/50 dark:text-text-secondary" />
