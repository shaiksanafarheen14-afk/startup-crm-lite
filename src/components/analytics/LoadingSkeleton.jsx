    ...
    <div className="animate-pulse space-y-8">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <div className="h-4 w-64 bg-slate-200 dark:bg-slate-700 rounded-md"></div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 flex items-center shadow-sm">
            <div className="w-12 h-12 rounded-lg bg-slate-200 dark:bg-slate-700 mr-4"></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="h-96 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
